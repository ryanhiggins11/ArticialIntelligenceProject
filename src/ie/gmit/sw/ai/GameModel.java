...
public class GameModel {
	...
	private void addGameCharacter(Collection<Task<Void>> tasks, char enemyID, char replace, int number){
		...
		while (counter < number){
			...
			if (model[row][col] == replace){
				 ...
				 */
				tasks.add(new CharacterTask(this, enemyID, row, col, ()-> System.out.println("Player Executing!")));
				counter++;
			}
		}
	}
	...
	public boolean isValidMove(int fromRow, int fromCol, int toRow, int toCol, char character) throws Exception{
		if (toRow <= this.size() - 1 && toCol <= this.size() - 1 && this.get(toRow, toCol) == ' '){
			this.set(fromRow, fromCol, '\u0020');
			this.set(toRow, toCol, character);
			return true;
		}else if(toRow <= this.size() - 1 && toCol <= this.size() - 1 && this.get(toRow, toCol) == '1'){
			this.set(fromRow, fromCol, '\u0020');
			this.set(toRow, toCol, character);
			ph.playerHit();
			System.out.println("Player Health = " + ph.getPlayerHealth());
			Dapping fl = new Dapping();
			double output = fl.getDappingLevel(ph.getPlayerHealth(), eh.getEnemyHealth());
		...
		else if(toRow <= this.size() - 1 && toCol <= this.size() - 1 && this.get(toRow, toCol) == '2'){
			this.set(fromRow, fromCol, '\u0020');
			this.set(toRow, toCol, character);
			ph.playerHit();
			System.out.println("Player Health = " + ph.getPlayerHealth());
...
//		else if(toRow <= this.size() - 1 && toCol <= this.size() - 1 && this.get(toRow, toCol) == '3'){
//			this.set(fromRow, fromCol, '\u0020');
//			this.set(toRow, toCol, character);
//			ph.playerHit();
//			System.out.println("Player Health = " + ph.getPlayerHealth());
...
//			return true;
//		}
//		else if(toRow <= this.size() - 1 && toCol <= this.size() - 1 && this.get(toRow, toCol) == '4'){
//			this.set(fromRow, fromCol, '\u0020');
//			this.set(toRow, toCol, character);
//			ph.playerHit();
//			System.out.println("Player Health = " + ph.getPlayerHealth());
...
//			return true;
//		}
//		else if(toRow <= this.size() - 1 && toCol <= this.size() - 1 && this.get(toRow, toCol) == '5'){
//			this.set(fromRow, fromCol, '\u0020');
//			this.set(toRow, toCol, character);
//			ph.playerHit();
//			System.out.println("Player Health = " + ph.getPlayerHealth());
